...
const CreateButton = memo(({ onClick }: { onClick: () => void }) => (
  <button
...
const ProjectCard = memo(
  ({ createdAt, id, name }: { createdAt: Date; id: string; name: string }) => (
    <Link
...
function ProjectInterface() {
  ...
  // Debounced toggle modal to prevent rapid clicks
...
export default memo(ProjectInterface);
